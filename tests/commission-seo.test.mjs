...
// Joe's rental commission is paid by the landlord and is not negotiable.
// /rent-out/ used to tell landlords it "comes from the tenant, not you" and
// that commission is "always negotiable" (both corrected 2026-09-19).
