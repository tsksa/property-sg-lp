...
| Ad landers | `sell/`, `sell-hdb/singapore/`, `rent-out/` | titles matched to Google Ads copy — **don't rebrand or retitle**. `sell-hdb/singapore/` is HDB-only and gates the Ads conversion on a qualifying question (JOE-333) |
